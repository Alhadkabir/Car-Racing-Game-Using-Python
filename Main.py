...
pygame.mixer.music.load('music/night.mp3')
...
# "Start" screen
drawText('Created by Alhad Kabir ', font, windowSurface, (WINDOWWIDTH / 3) - 30, (WINDOWHEIGHT / 3))
drawText('Press any key to start the game & Enjoy', font, windowSurface, (WINDOWWIDTH / 3), (WINDOWHEIGHT / 3)+30)
